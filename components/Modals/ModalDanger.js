...
export default ({ title, desc, setState, onClick, loading }) => {
    ...
    return (
        <div className="fixed inset-0 z-10 overflow-y-auto">
            <div className="fixed inset-0 w-full h-full bg-black opacity-40" onClick={setState}></div>
                    ...
                    <div className="mt-3 sm:flex">
                        ...
                        <div className="mt-2 text-center sm:ml-4 sm:text-left">
                            ...
                            <div className="items-center gap-2 mt-3 sm:flex">
                                <button className="flex items-center justify-center w-full mt-2 p-2.5 flex-1 text-white bg-red-600 rounded-md outline-none ring-offset-2 ring-red-600 focus:ring-2"
                                    onClick={onClick}
                                >
                                    {
                                        loading ? (
